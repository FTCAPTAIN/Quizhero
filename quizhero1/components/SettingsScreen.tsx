  ...
  <button
    ...
    className={`flex-1 flex flex-col items-center justify-center p-3 rounded-lg border-2 transition-all duration-200 ${
      isSelected
        ...
        : 'bg-slate-200 dark:bg-slate-700/50 border-transparent hover:bg-slate-300 dark:hover:bg-slate-700'
    }`}
  >
...
const SettingsScreen: React.FC<SettingsScreenProps> = ({ onNavigate, theme, setTheme, themeColor, setThemeColor }) => {
  const { t } = useLanguage();
    ...
    <div className="relative flex flex-col h-full w-full p-4 md:p-6 text-slate-800 dark:text-white overflow-y-auto animate-fade-in">
      ...
      <div className="w-full max-w-2xl mx-auto space-y-4">
        ...
        <div className="bg-slate-100 dark:bg-slate-800/50 p-4 rounded-lg">
           <h3 className="font-semibold text-lg mb-1">{t('appearance')}</h3>
