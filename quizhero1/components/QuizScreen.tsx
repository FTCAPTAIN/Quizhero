...
const QuizScreen: React.FC<QuizScreenProps> = ({ question, onAnswer, onNext, questionNumber, totalQuestions, difficulty, score, onExit, isAiEnabled }) => {
  ...
  useEffect(() => {
    ...
    // Clear any pending timeout when the question changes
  ...
  const handleSelectAnswer = (option: string) => {
    ...
    // Uniform 2-second delay for feedback before next question
    nextQuestionTimeoutRef.current = window.setTimeout(onNext, 2000);
  };
          ...
          <div className="w-full max-w-3xl flex flex-col items-center">
            <div className="mb-4">
              <Timer
                ...
                isPaused={selectedAnswer !== null || isHintLoading || showExitConfirm}
                onTick={handleTick}
              />
            </div>
