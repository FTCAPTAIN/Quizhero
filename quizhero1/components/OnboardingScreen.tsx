...
import { HomeIcon, SparklesIcon, LeaderboardIcon, QuestionMarkCircleIcon } from './Icons';
...
const OnboardingScreen: React.FC<OnboardingScreenProps> = ({ onFinish }) => {
  ...
  const steps = [
    {
      icon: <QuestionMarkCircleIcon className="w-16 h-16 text-cyan-400" />,
    ...
    },
    {
      ...
      title: t('onboarding_final_title'),
      subtitle: t('onboarding_final_subtitle'),
    },
  ];
